...
public class Customer {
    ...
    public String getCust_psoition() {
        return cust_psoition;
    }

    public void setCust_psoition(String cust_psoition) {
        this.cust_psoition = cust_psoition;
    }
