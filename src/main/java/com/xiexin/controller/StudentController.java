...
public class StudentController {
    ...
    //全查 注意 不用map 公司中都用一个类 好几类组成的类 ，叫做
    //统一响应类，每个公司都不一样。
    ...
    public Result selectPageAll(String studentName,Integer studentSex, @RequestParam(value = "page" ,defaultValue = "1",required = true) Integer page,
